...
export interface VeriConnectInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
  ...
  encodeFunctionData(
    functionFragment: "getMyOwnedCardIds",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "ownerToCardIds",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "registerCard",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface VeriConnect extends BaseContract {
  connect(runner?: ContractRunner | null): VeriConnect;
  waitForDeployment(): Promise<this>;

  interface: VeriConnectInterface;
  ...
  cardOwners: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  ownerToCardIds: TypedContractMethod<
    [arg0: AddressLike, arg1: BigNumberish],
    [bigint],
    "view"
  >;

  registerCard: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "ownerToCardIds"
  ): TypedContractMethod<
    [arg0: AddressLike, arg1: BigNumberish],
    [bigint],
    "view"
